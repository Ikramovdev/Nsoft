        ...
        <div className='w-full lg:w-[1680px] mx-auto overflow-hidden'>
            ...
            <div className='Contactform bg-white rounded-[9px] mx-[21px] lg:mx-0 lg:rounded-[47px] py-[18px] lg:py-[111px] px-[18px] lg:px-[40px] text-center lg:text-left mb-2 lg:mb-5'>
               ...
               <form className='mx-auto' onSubmit={handleContactSubmit} autoComplete='off'>
                    <input className='w-[100px] lg:w-[331px] bg-[#00B669] rounded-[12.12px] lg:rounded-[37.5px] py-[6px] lg:pt-[17px] lg:pb-[23px] pl-2 lg:pl-[25px] pr-[2px] lg:pr-[5px] text-white text-[9.71px] lg:text-[25px] leading-[11.35px] lg:leading-[35.7px] placeholder:text-white placeholder:text-[9.71px] placeholder:lg:text-[23px] placeholder:leading-[11.35px] placeholder:lg:leading-[35.7px] outline-none focus:shadow-md focus:shadow-green-600' name={'userName'} type="text" placeholder='Ism' required/>
                    <input className='w-[100px] lg:w-[331px] bg-[#00B669] rounded-[12.12px] lg:rounded-[37.5px] py-[6px] lg:pt-[17px] lg:pb-[23px] pl-2 lg:pl-[25px] pr-[2px] lg:pr-[5px] text-white text-[9.71px] lg:text-[25px] leading-[11.35px] lg:leading-[35.7px] placeholder:text-white placeholder:text-[9.71px] placeholder:lg:text-[23px] placeholder:leading-[11.35px] placeholder:lg:leading-[35.7px] outline-none focus:shadow-md focus:shadow-green-600' name={'userNumber'} type="tel" placeholder='Tel' required/>
            ...
            <div className='contact mx-[21px] lg:mx-0'>
                <div className='bg-white w-full lg:w-[972px] pt-[12px] lg:pt-[62px] pl-[9px] lg:pl-[40px] rounded-[12.39px] lg:rounded-[62px] flex justify-between lg:justify-start space-x-[35px] lg:space-x-[208px] mb-1 lg:mb-0'>
                    <div>
                        ...
                        <a href='tel:+998930605011' className='font-regular text-[8px] lg:text-[35px] text-black leading-[9.6px] lg:leading-[42px] mb-[4px] lg:mb-[30px]'>+998 93 060 50 11</a>
